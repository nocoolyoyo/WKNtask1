                ...
                <div id="content-area-right">
                    <form class="content-area-actionList form-inline action-bar" role="form">
                            <div class="form-group left">
                                <button type="button" class="btn btn-primary">录入会员</button>
                                <button type="button" class="btn btn-primary">导入会员</button>
                                <button type="button" class="btn btn-primary">导出会员</button>
                            </div>
                            <div class="form-group right">
                                <input  class="form-control" type="text"  name="search"  placeholder="名字/账号/单位">
                    ...
                    <table class="content-area-tableList table table-bordered table-hover">
                        <thead>
                            <tr>
                                    <th>姓名</th>
                                    <th>手机号</th>
