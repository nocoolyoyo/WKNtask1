        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6 right">
                <div id="calendar-box">
                 ...
                 <div id="backlog-box">
                    <button id="backlog-add" type="button" class="button button-raised button-normal button-green button-circle right" data-toggle="modal" data-target="#backlog-modal" onclick="addBacklog();">
                        ...
                        <div class="modal-content">
                            <form role="form">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn button button-primary button-rounded" onclick=savememor($("textarea").val(),$("#memorid").val());  data-dismiss="modal">保存</button>
    			...
    			success:function(ret){
    				if(ret.STATUS =="0"){
    					...
    					for (var int = 0; int < ret.ACTIVITY.length; int++) {
							...
							+"<th><a href='#' onclick='javascript:showBacklogDetail( "+ret.ACTIVITY[int].MEMORID+",\""+ret.ACTIVITY[int].CONTENT+"\");' data-toggle='modal' data-target='#backlog-modal'>"+ret.ACTIVITY[int].CONTENT+"</a></th>"
							+"<th><button type='button' class='backlog-delete button button-raised button-caution button-circle button-tiny right' href='#' onclick='javascript:deleteBacklog("+ret.ACTIVITY[int].MEMORID+",this)'><i class='fa fa-minus-circle'></i></button></th></tr>";
						}
    					$("#todo").html(name);
    				}
    			}
