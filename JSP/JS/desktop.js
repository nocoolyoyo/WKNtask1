    ...
    $(function(){
        ...
        function loadRenderBoard(){
            ...
            for (var j = 0; j < Menu.manage.length; j++) {
                $board_manage.append('<li class="col-xs-3 col-sm-3"><a href="' + basePath+"/admin/url/" + Menu.manage[j].url + '.shtml" role="button">' + '<span><i class="fa ' + Menu.manage[j].icon + '"></i>' + Menu.manage[j].name + '</span></a></li>');
            }
        }
