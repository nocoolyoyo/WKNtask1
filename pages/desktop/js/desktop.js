	...
	var $board_manage = $("#board ul:eq(1)");
		...
		function loadRenderBoard(){
			for (var i = 0; i < Menu.daily.length; i++) {
				$board_daily.append('<li class="col-xs-3 col-sm-3"><a href="#/'+ Menu.daily[i].url + '">' + '<span class="desktop-link"><i class="fa ' + Menu.daily[i].icon + '"></i>' + Menu.daily[i].name + '</span></a></li>');
			}
