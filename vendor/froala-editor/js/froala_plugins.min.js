...
//Video Upload
!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"==typeof module&&module.exports?module.exports=function(b,c){return void 0===c&&(c="undefined"!=typeof window?require("jquery"):require("jquery")(b)),a(c),c}:a(jQuery)}(function(a){a.extend(a.FE.POPUP_TEMPLATES,{"video.insert":"[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}),a.extend(a.FE.DEFAULTS,{videoUploadURL:"https://i.froala.com/upload",videoUploadParam:"file",videoUploadParams:{},videoUploadToS3:!1,videoUploadMethod:"POST",videoMaxSize:10485760,videoAllowedTypes:["*"],videoInsertButtons:["videoBack","|"],videoUseSelectedText:!1}),a.FE.PLUGINS.video=function(b){function c(){var a=b.$tb.find('.fr-command[data-cmd="insertVideo"]'),c=b.popups.get("video.insert");if(c||(c=s()),e(),!c.hasClass("fr-active")){b.popups.refresh("video.insert"),b.popups.setContainer("video.insert",b.$tb);var d=a.offset().left+a.outerWidth()/2,f=a.offset().top+(b.opts.toolbarBottom?0:a.outerHeight());b.popups.show("video.insert",d,f,a.outerHeight())}}function d(){var a=b.popups.get("video.insert");a||(a=s()),a.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"),a.find(".fr-video-progress-bar-layer").addClass("fr-active"),a.find(".fr-buttons").hide(),f("Uploading",0)}function e(a){var c=b.popups.get("video.insert");c&&(c.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"),c.find(".fr-video-progress-bar-layer").removeClass("fr-active"),c.find(".fr-buttons").show(),a&&b.popups.show("video.insert",null,null))}function f(a,c){var d=b.popups.get("video.insert");if(d){var e=d.find(".fr-video-progress-bar-layer");e.find("h3").text(a+(c?" "+c+"%":"")),e.removeClass("fr-error"),c?(e.find("div").removeClass("fr-indeterminate"),e.find("div > span").css("width",c+"%")):e.find("div").addClass("fr-indeterminate")}}function g(a){d();var c=b.popups.get("video.insert"),e=c.find(".fr-video-progress-bar-layer");e.addClass("fr-error"),e.find("h3").text(a)}
    function h(a,c,d){
        /* function videoFormat(){
         ...
         suffix[0]==='.ogg'||
         suffix[0]==='.WebM'){
         return  '<div style="display: block;" id="fr-inserted-video" class="fr-video">'+
         '<video controls="controls" width:100% poster="./img/imgHolder1-1.png">'+
         '<source src="'+ a +'"/>'+
         //   '<source src="http://localhost:8080/SHANGHUI/download/test.ogg">'+
         '</video>'+
         '</div>';
         }else{
         return '<a href="'+a+'" id="fr-inserted-video" class="fr-video">'+(c||b.selection.text())+'</a>';
         }
         }*/

        b.edit.on(),b.events.focus(!0),b.selection.restore(),
            b.html.insert(  
            		'<div id="fr-inserted-video" style="width:auto"  class="fr-video fr-dib fr-draggable">'+
                '<video  class="fr-video fr-dib fr-draggable" controls="controls" width="100%" poster="../../img/imgHolder1-1.png">'+
                '<source src="'+ a +'"/>'+
                //'<source src="http://localhost:8080/SHANGHUI/download/test.ogg">'+
                '</video>'+
                '</div>');
        var e=b.$el.find("#fr-inserted-video");
        e.removeAttr("id"),b.popups.hide("video.insert"),b.undo.saveStep(),x(),b.events.trigger("video.inserted",[e,d])
    }
    function i(c){try{if(b.events.trigger("video.uploaded",[c],!0)===!1)return b.edit.on(),!1;var d=a.parseJSON(c);
        return d.link?d:(n(A,c),!1)}catch(e){return n(C,c),!1}}function j(c){try{var d=a(c).find("Location").text(),e=a(c).find("Key").text();return b.events.trigger("video.uploadedToS3",[d,e,c],!0)===!1?(b.edit.on(),!1):d}catch(f){return n(C,c),!1}}function k(a){var c=this.status,d=this.response,e=this.responseXML,f=this.responseText;try{if(b.opts.videoUploadToS3)if(201==c){var g=j(e);g&&h(g,a,d||e)}else n(C,d||e);else if(c>=200&&300>c){var k=i(f);k&&h(k.link,a,d||f)}else n(B,d||f)}catch(l){n(C,d||f)}}function l(){n(C,this.response||this.responseText||this.responseXML)}function m(a){if(a.lengthComputable){var b=a.loaded/a.total*100|0;f("Uploading",b)}}function n(a,c){b.edit.on(),g(b.language.translate("Something went wrong. Please try again.")),b.events.trigger("video.error",[{code:a,message:G[a]},c])}function o(){b.edit.on(),e(!0)}function p(a){if("undefined"!=typeof a&&a.length>0){if(b.events.trigger("video.beforeUpload",[a])===!1)return!1;var c=a[0];if(c.size>b.opts.videoMaxSize)return n(D),!1;if(b.opts.videoAllowedTypes.indexOf("*")<0&&b.opts.videoAllowedTypes.indexOf(c.type.replace(/video\//g,""))<0)return n(E),!1;var e;if(b.drag_support.formdata&&(e=b.drag_support.formdata?new FormData:null),e){var f;if(b.opts.videoUploadToS3!==!1){e.append("key",b.opts.videoUploadToS3.keyStart+(new Date).getTime()+"-"+(c.name||"untitled")),e.append("success_action_status","201"),e.append("X-Requested-With","xhr"),e.append("Content-Type",c.type);for(f in b.opts.videoUploadToS3.params)b.opts.videoUploadToS3.params.hasOwnProperty(f)&&e.append(f,b.opts.videoUploadToS3.params[f])}for(f in b.opts.videoUploadParams)b.opts.videoUploadParams.hasOwnProperty(f)&&e.append(f,b.opts.videoUploadParams[f]);e.append(b.opts.videoUploadParam,c);var g=b.opts.videoUploadURL;b.opts.videoUploadToS3&&(g=b.opts.videoUploadToS3.uploadURL?b.opts.videoUploadToS3.uploadURL:"https://"+b.opts.videoUploadToS3.region+".amazonaws.com/"+b.opts.videoUploadToS3.bucket);var h=b.core.getXHR(g,b.opts.videoUploadMethod);h.onload=function(){k.call(h,b.opts.videoUseSelectedText?null:c.name)},h.onerror=l,h.upload.onprogress=m,h.onabort=o,d(),b.edit.off();var i=b.popups.get("video.insert");i&&i.off("abortUpload").on("abortUpload",function(){4!=h.readyState&&h.abort()}),h.send(e)}}}function q(c){b.events.$on(c,"dragover dragenter",".fr-video-upload-layer",function(){return a(this).addClass("fr-drop"),!1},!0),b.events.$on(c,"dragleave dragend",".fr-video-upload-layer",function(){return a(this).removeClass("fr-drop"),!1},!0),b.events.$on(c,"drop",".fr-video-upload-layer",function(d){d.preventDefault(),d.stopPropagation(),a(this).removeClass("fr-drop");var e=d.originalEvent.dataTransfer;if(e&&e.files){var f=c.data("instance")||b;f.video.upload(e.files)}},!0),b.events.$on(c,"change",'.fr-video-upload-layer input[type="file"]',function(){if(this.files){var d=c.data("instance")||b;d.video.upload(this.files)}a(this).val("")},!0)}function r(){e()}function s(a){if(a)return b.popups.onHide("video.insert",r),!0;var c="";c='<div class="fr-buttons">'+b.button.buildList(b.opts.videoInsertButtons)+"</div>";var d="";d='<div class="fr-video-upload-layer fr-layer fr-active" id="fr-video-upload-layer-'+b.id+'"><strong>'+b.language.translate("Drop video")+"</strong><br>("+b.language.translate("or click")+')<div class="fr-form"><input type="file" name="'+b.opts.videoUploadParam+'" accept="/*" tabIndex="-1"></div></div>';var e='<div class="fr-video-progress-bar-layer fr-layer"><h3 class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command" data-cmd="videoDismissError" tabIndex="2">OK</button></div></div>',f={buttons:c,upload_layer:d,progress_bar:e},g=b.popups.create("video.insert",f);return q(g),g}function t(c){return a(c).hasClass("fr-video")?b.events.trigger("video.unlink",[c]):void 0}function u(c){var e=c.originalEvent.dataTransfer;if(e&&e.files&&e.files.length){var f=e.files[0];if(f&&"undefined"!=typeof f.type&&f.type.indexOf("image")<0&&(b.opts.videoAllowedTypes.indexOf(f.type)>=0||b.opts.videoAllowedTypes.indexOf("*")>=0)){b.markers.remove(),b.markers.insertAtPoint(c.originalEvent),b.$el.find(".fr-marker").replaceWith(a.FE.MARKERS),b.popups.hideAll();var g=b.popups.get("video.insert");return g||(g=s()),b.popups.setContainer("video.insert",a(b.opts.scrollableContainer)),b.popups.show("video.insert",c.originalEvent.pageX,c.originalEvent.pageY),d(),p(e.files),c.preventDefault(),c.stopPropagation(),!1}}}function v(){b.events.on("drop",u),b.events.$on(b.$win,"keydown",function(c){var d=c.which,e=b.popups.get("video.insert");e&&d==a.FE.KEYCODE.ESC&&e.trigger("abortUpload")}),b.events.on("destroy",function(){var a=b.popups.get("video.insert");a&&a.trigger("abortUpload")})}function w(){b.events.disableBlur(),b.selection.restore(),b.events.enableBlur(),b.popups.hide("video.insert"),b.toolbar.showInline()}function x(){var a,c=Array.prototype.slice.call(b.$el.get(0).querySelectorAll(".fr-video")),d=[];for(a=0;a<c.length;a++)d.push(c[a].getAttribute("href"));if(H)for(a=0;a<H.length;a++)d.indexOf(H[a].getAttribute("href"))<0&&b.events.trigger("video.unlink",[H[a]]);H=c}function y(){v(),b.events.on("link.beforeRemove",t),b.$wp&&(x(),b.events.on("contentChanged",x)),s(!0)}var z=1,A=2,B=3,C=4,D=5,E=6,F=7,G={};G[z]="Video cannot be loaded from the passed link.",G[A]="No link in upload response.",G[B]="Error during video upload.",G[C]="Parsing response failed.",G[D]="Video is too large.",G[E]="Video video type is invalid.",G[F]="Videos can be uploaded only to same domain in IE 8 and IE 9.";var H;return{_init:y,showInsertPopup:c,upload:p,insert:h,back:w,hideProgressBar:e}},a.FE.DefineIcon("insertVideo",{NAME:"video-camera"}),a.FE.RegisterCommand("insertVideo",{title:"Upload Video",undo:!1,focus:!0,refreshAfterCallback:!1,popup:!0,callback:function(){this.popups.isVisible("video.insert")?(this.$el.find(".fr-marker")&&(this.events.disableBlur(),this.selection.restore()),this.popups.hide("video.insert")):this.video.showInsertPopup()},plugin:"video"}),a.FE.DefineIcon("videoBack",{NAME:"arrow-left"}),a.FE.RegisterCommand("videoBack",{title:"Back",undo:!1,focus:!1,back:!0,refreshAfterCallback:!1,callback:function(){this.video.back()},refresh:function(a){this.opts.toolbarInline?(a.removeClass("fr-hidden"),a.next(".fr-separator").removeClass("fr-hidden")):(a.addClass("fr-hidden"),a.next(".fr-separator").addClass("fr-hidden"))}}),a.FE.RegisterCommand("videoDismissError",{title:"OK",callback:function(){this.video.hideProgressBar(!0)}})});
