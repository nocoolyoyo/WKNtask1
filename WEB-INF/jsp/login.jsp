...
<body onkeydown="keyLogin();">
	<div id="browserFail" style="display: none">
		<div id="help-left-arrow" style="display:none"><img src="<%=basePath%>img/browser/help_lt_arrow.png"/></div>
	    <div id="browserFail-box">  
	    		 
	    </div>
	    <div id="help-right-arrow"><img src="<%=basePath%>img/browser/help_rt_arrow.png"/></div> 
	    <ul id="help-nav">
	    	<li><img src="<%=basePath%>img/browser/page_nav_1_active.png" role="button"/></li>
	    	<li><img src="<%=basePath%>img/browser/page_nav_2.png" role="button"/></li>
	    	<li><img src="<%=basePath%>img/browser/page_nav_3.png" role="button"/></li>
	    	<li><img src="<%=basePath%>img/browser/page_nav_4.png" role="button"/></li>
	    </ul>     
	</div>
...
<script type="text/javascript">
    function keyLogin(){
        if (event.keyCode && event.keyCode==13)  //回车键的键值为13
